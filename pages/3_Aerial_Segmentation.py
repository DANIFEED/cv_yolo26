...
st.caption("Сегментация объектов на аэроснимках (дома, дороги, участки)")
...
MODEL_PATH = "models/best_aerial.pt"  # TODO: положить сюда реальные веса       #  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
with tab3:
    ...
    • Model: YOLOv11 Aerial (указать версию: n / s / m)    #  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    <br>
    ...
    loss_path = "models/metrics_aerial/loss_curve.png"               #  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    pr_path = "models/metrics_aerial/pr_curve.png"                   #  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    cm_path = "models/metrics_aerial/confusion_matrix.png"           #  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
if images:
    ...
    try:
        ...
        st.error("Model weights not found. Проверь путь к best_aerial.pt.")
        st.stop()
    ...
    for name, img in images:
        ...
        with col2:
            st.caption("Segmentation Result")
